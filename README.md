...
<h3 align="center">Python Programmer 🧠 | Content Creator 🎥 | Founder of Kdd ibrahim</a> 📚</h3>

<p align="center">
  <a href="https://instagram.com/kddibrahim"><img src="https://img.shields.io/badge/@kddibrahim-E4405F?style=for-the-badge&logo=instagram&logoColor=white" /></a>
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,flutter,dart,cpp,java,vscode,github,figma,git,bash,photoshop,illustrator" />
</p>
...
```dart
class Ibrahim {
  String role = "Python Programmer & Designer";
  String language = "Arabic";
  String brand = "Kddibrahim |";
  List<String> skills = [
    "Python, C++",
    "Flutter UI/UX",
    "Dart Animations",
...
- -->
- 📦 Making **codding Simple** to learn for beginners
